...
def login_user(db: Session, login_user_request: models.LoginRequests) -> models.Token:
    ...
    return models.Token(access_token=token, token_type="bearer", email=user.email)
